...
export default function ChannelBar({channels}) {
    ...
    return (
        <div className="min-h-0 w-60 bg-[#2f3136] grow-0 shrink-0 basis-auto max-h-full">
            <div className="h-12 z-2 px-2.5 m-auto w-full flex flex-col align-center justify-center pl-5 text-white font-bold">
                Server name
            </div>
            <div className="h-[calc(100%_-_100px)] flex-1 grow-1 basis-auto">
                <ul className="h-full max-h-[calc(100%_-_100px)]">
                    <div className='w-full h-px bg-[#202225]' key="line"/>
