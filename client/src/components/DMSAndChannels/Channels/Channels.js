...
export default function ChannelBar({channels, serverName}) {
    ...
    return (
        <div className="min-h-0 w-60 bg-[#2f3136] grow-0 shrink-0 basis-auto max-h-full">
            <div className="hover:bg-[#42464d] h-12 px-2.5 my-auto w-full flex align-center justify-center pl-5 text-white font-bold border-b border-[#202225]" onClick={() => setShowDropdown((prev) => !prev)}>
            ...
            <div className={`${showDropdown ? "visible" : "invisible"}`}>
                <ChannelDropDown setShowDropdown={setShowDropdown}/>
            </div>
